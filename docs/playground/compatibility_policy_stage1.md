# Playground API Compatibility Policy (Stage 1 Legacy Baseline)

This policy maps the playground technical specification routes to Stage 1 read-only bridge scope.
For the Stage 6 read-only observability route matrix, see `docs/playground/compatibility_policy_stage6.md`.
